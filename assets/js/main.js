...
(function() {
    $(document).ready(function () {
        ...
        $.getJSON('https://blog.luiscarlospando.com/wp-json/wp/v2/posts?per_page=1', function (data) {
            $('#blog').append('<div style="display: inline;"><a href="' + data.posts[0].link + '">' + data.posts[0].title + '</a></div>');
        }
