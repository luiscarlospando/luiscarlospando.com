...
function buildStreamingLinksHTML(track) {
    ...
    return `
                    <ul class="list-inline mb-0">
                      ${track.apple_music_url ? `<li class="list-inline-item"><a class="btn btn-primary btn-sm mb-2 mb-lg-0" href="${track.apple_music_url}" target="_blank" rel="noopener"><i class="fa-brands fa-apple" aria-hidden="true"></i> Abrir en Apple Music</a></li>` : ""}
                      ...
                      <li class="list-inline-item">
                        <a class="btn btn-primary btn-sm mb-2 mb-lg-0" href="${track.url}" target="_blank" rel="noopener"><i class="fa-brands fa-lastfm" aria-hidden="true"></i> Abrir en Last.fm</a>
                      </li>
                    </ul>`;
}
