/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism-tomorrow&languages=markup+css+clike+javascript+applescript+bash+dns-zone-file+docker+git+go+graphql+http+json+json5+jsonp+liquid+markdown+markup-templating+nginx+php+python+jsx+tsx+ruby+sass+scss+sql+toml+typescript+typoscript+vim+yaml */
var _self =
