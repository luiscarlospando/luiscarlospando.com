/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism&languages=markup+css+clike+javascript+applescript+bash+dns-zone-file+docker+git+go+http+json+json5+jsonp+liquid+markdown+markup-templating+nginx+php+powershell+python+jsx+tsx+ruby+sass+scss+sql+toml+typescript+yaml */
var _self =
