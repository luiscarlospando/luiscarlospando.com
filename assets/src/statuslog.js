...
function renderStatus(data) {
    ...
    const replyLink = externalURL
        ? ` · <a href="${externalURL}" rel="me noreferrer noopener" aria-label="Responder" target="_blank"><em><i class="fa-solid fa-reply"></i> Responder</em></a>`
        : "";
    ...
    statusElement.innerHTML = `
        <div id="container" class="text-center">
            ...
            <small class="text-muted">
                ...
                · <a href="https://luiscarlospando.com/status" aria-label="Ver todos mis estatus"><em><i class="fa-solid fa-list"></i> Ver todos</em></a>${replyLink}
            </small>
        </div>
    `;
