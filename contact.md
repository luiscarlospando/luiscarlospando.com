...
Una manera rápida y sencilla de mandarme algo (anónimamente o no) es [ir a mi guestbook][1] y dejarme un mensaje por ahí.

---

## <i class="fa-solid fa-paintbrush"></i> Paintbook

O si quieres, puedes dibujarme algo en [mi paintbook][2] y mandarme tu dibujo por ahí.

---

## <i class="fa-brands fa-signal-messenger"></i> Signal

También me puedes contactar de manera segura por [Signal][3]{:rel="me noopener" target="_blank"}, mi username es <a href="{{ site.signal_url }}" rel="me noopener" target="_blank"><code>{{ site.signal_username }}</code></a>.
...
Cuando necesito generar links rápidamente, utilizo [omg.lol][9]{:target="_blank"}, aquí comparto [los links que he generado][11]{:rel="me noopener" target="_blank"}.

---

## <i class="fa-solid fa-record-vinyl"></i> Crucial Tracks

En [mi perfil de Crucial Tracks][12]{:rel="me noopener" target="_blank"} llevo un diario, no de mis canciones favoritas, sino de las canciones que me han marcado y definido de alguna manera.

---

## <i class="fa-brands fa-itunes-note"></i> Apple Music

Este es [mi perfil en Apple Music][13]{:rel="me noopener" target="_blank"}.

---

## <i class="fa-brands fa-lastfm"></i> Last.fm

Este es [mi perfil en Last.fm][14]{:rel="me noopener" target="_blank"}.

---

## <i class="fa-brands fa-reddit"></i> Reddit [![Reddit User Karma](https://img.shields.io/reddit/user-karma/combined/luiscarlospando)][15]{:rel="me noopener" target="_blank"}

Este es [mi perfil en Reddit][15]{:rel="me noopener" target="_blank"}.

---

## <i class="fa-brands fa-youtube"></i> YouTube

[Este es mi canal personal de YouTube][16], que también uso para hacer streams en vivo.

---

## <i class="fa-brands fa-twitch"></i> Twitch [![Twitch Status](https://img.shields.io/twitch/status/{{ site.twitch_username }}?style=flat&logo=twitch&logoColor=%23A172F7&link=https%3A%2F%2Fluiscarlospando.com%2Flive)][17]{:rel="me noopener" target="_blank"}

Checa también [mi canal en Twitch][18].

---

## <i class="fa-solid fa-gamepad"></i> Backloggd

En [Backloggd][19]{:rel="me noopener" target="_blank"} llevo el control de los videojuegos que tengo.

[1]: /guestbook/
[2]: /paintbook/
[3]: {{ site.signal_url }}
[4]: {{ site.hitzmx_profile }}
[5]: {{ site.instagram_url }}
[6]: {{ site.discord_profile }}
[7]: /chat/
[8]: https://{{ site.omglol_username }}.{{ site.domain }}/
[9]: https://home.omg.lol/referred-by/{{ site.omglol_username }}
[10]: https://pics.{{ site.domain }}/
[11]: https://purls.{{ site.domain }}/
[12]: {{ site.crucial_tracks_url }}
[13]: {{ site.apple_music_url }}
[14]: {{ site.lastfm_url }}
[15]: {{ site.reddit_url }}
[16]: {{ site.youtube_url }}
[17]: {{ site.twitch_url }}
[18]: /live/
[19]: {{ site.backloggd_url }}
[20]: {{ site.spacehey_url }}
[21]: {{ site.pi_referal_url }}
