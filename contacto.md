...
<a href="mailto:{{ site.email }}" class="btn btn-primary btn-sm d-block" data-toggle="tooltip" data-placement="top" title="Escribir correo">
...
<a rel="me" href="{{ site.mastodon_url }}" class="btn btn-primary btn-sm d-block" data-toggle="tooltip" data-placement="top" title="Seguir a @{{ site.mastodon_username }} en Mastodon" target="_blank">
<i class="fa-brands fa-mastodon"></i> Seguir a @{{ site.mastodon_username }}
</a>
Cuenta personal.

<a rel="me" href="https://hachyderm.io/@{{ site.mastodon_feed }}" class="btn btn-primary btn-sm d-block" data-toggle="tooltip" data-placement="top" title="Seguir a @{{ site.mastodon_feed }} en Mastodon" target="_blank">
