...
## <i class="fa-solid fa-circle-question"></i> Ask me anything (AMA) @ GitHub
...
## <i class="fa-solid fa-code-branch"></i> SourceTube
...
Aquí tengo mis [pastes][7]{:rel="me" target="_blank"}.
...
Este es [mi perfil en Stack Overflow][8]{:rel="me" target="_blank"}.

---

## <i class="fa-brands fa-dev"></i> Dev.to
Me puedes encontrar en Dev.to [aquí][9]{:rel="me" target="_blank"}.

---

## <i class="fa-brands fa-codepen"></i> CodePen
Mi perfil en CodePen es [este][10]{:rel="me" target="_blank"}.

---

## <i class="fa-solid fa-beer-mug-empty"></i> Brewfile
Aquí comparto lo que tengo en [mi Brewfile][11]{:rel="me" target="_blank"}.
...
[11]: https://www.brewfiles.com/brew/r9SnmnQnfinX3cvQkxO6
