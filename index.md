...
<ul class="list-inline">
    <li class="list-inline-item">
        <a href="/acerca-de/" class="btn btn-primary btn-sm mb-3 mb-xl-0" data-toggle="tooltip" data-placement="top" aria-label="Conoce más sobre mi" title="Conoce más sobre mi">
            <i class="fa-solid fa-circle-info"></i> Acerca de
        </a>
    </li>
    <li class="list-inline-item">
        <a href="/now/" class="btn btn-primary btn-sm mb-3 mb-xl-0" data-toggle="tooltip" data-placement="top" aria-label="Ve en qué ando actualmente" title="Ve en qué ando actualmente">
    ...
    <li class="list-inline-item">
        <a href="/photos/" class="btn btn-primary btn-sm mb-3 mb-xl-0" data-toggle="tooltip" data-placement="top" aria-label="Ve las fotos que he tomado con mi iPhone" title="Ve las fotos que he tomado con mi iPhone">
    ...
    <li class="list-inline-item">
        <a href="/contacto/" class="btn btn-primary btn-sm mb-3 mb-xl-0" data-toggle="tooltip" data-placement="top" aria-label="Revisa las maneras de ponerte en contacto conmigo" title="Revisa las maneras de ponerte en contacto conmigo">
            <i class="fa-solid fa-address-card"></i> Contacto
        </a>
    </li>
    <li class="list-inline-item">
        <a href="/guestbook/" class="btn btn-primary btn-sm mb-3 mb-xl-0" data-toggle="tooltip" data-placement="top" aria-label="Deja un mensaje en mi guestbook" title="Deja un mensaje en mi guestbook">
    ...
    <li class="list-inline-item">
        <a href="/blogroll/" class="btn btn-primary btn-sm mb-3 mb-xl-0" data-toggle="tooltip" data-placement="top" aria-label="Revisa mis blogs y websites favoritos" title="Revisa mis blogs y websites favoritos">
