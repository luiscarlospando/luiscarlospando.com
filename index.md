...
Mi razón de crear este sitio fue mi amor por las computadoras 👨‍💻 y el Internet 🌐. Tuve esa necesidad de tener [mi propio espacio en la web][5], para hablar de lo que yo quisiera, experimentar sin miedo a equivocarme, compartir y aprender. Básicamente busco que este sea un lugar donde concentre todo lo que soy y <strong>todo lo que hago</strong>. 😌 Por cierto, ahora estoy [compartiendo mis fotos aquí][6]. 📸 <span class="badge badge-primary">Nuevo</span>
...
BTW, si te animas, puedes pasar a [firmar mi guestbook][16]. ✌️ <span class="badge badge-primary">Nuevo</span>
</div>
