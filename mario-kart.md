...
tags: [mario-kart, nintendo, mode-7, mode-7-grand-prix, m7gp]
...
<input type="text" class="form-control clipboard-field" id="m7gp-code" value="{{ site.m7gp_code }}" data-toggle="tooltip" data-placement="top" data-trigger="focus" title="Código del torneo copiado 🎉" aria-label="Código del torneo, haz clic para copiar" aria-describedby readonly>
...
- Puedes revisar todos mis posts sobre *Mario Kart 8* en este hashtag: <a class="badge badge-custom" href="{{ site.blog_url }}/hashtag/mario-kart-8/">#Mario Kart 8</a>
